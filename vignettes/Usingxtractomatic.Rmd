...
The `xtractomatic` package is not available through <span style="color:blue">CRAN</span> at the moment, but it is available from [Github](https://github.com/rmendels/xtractomatic)
 
To install the `xtractomatic` package from <span style="color:blue">Github</span> ,
